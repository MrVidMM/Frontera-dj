...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-06-2022 a las 21:49:44
...
DROP TABLE IF EXISTS `db_carrito`;
...
DROP TABLE IF EXISTS `db_estadoseguimiento`;
...
DROP TABLE IF EXISTS `db_historial`;
...
DROP TABLE IF EXISTS `db_seguiento`;
